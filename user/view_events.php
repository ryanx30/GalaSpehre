...
<body>
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a class='menu-trigger' id="menu-toggle">
                            <span>Menu</span>
                        </a>
                    </nav>
                </div>
                                ...
                                <div class="down-content">
                                    <div class="left-content">
                                        <div class="main-white-button">
                                            ...
                                            $eventId = $event['id'];
                                            if ($eventId == 1) {
                                                $href = "ticketdetails1.php?id=" . $eventId;
                                            } elseif ($eventId == 2) {
                                                $href = "ticketdetails2.php?id=" . $eventId;
                                            } elseif ($eventId == 3) {
                                                $href = "ticketdetails3.php?id=" . $eventId;
                                            }
                                            ?>
                                            <a href="<?php echo $href; ?>">Purchase Tickets</a>
                                        </div>
                                    </div>
    ...
    <div class="coming-events">
        <div class="left-button">
            <div class="main-white-button">
                <a href="tickets.php">Discover More</a>
            </div>
        </div>
        <div class="container">
            <div class="row">
