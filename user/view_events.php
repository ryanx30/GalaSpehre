...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light py-3">
        ...
        <div class="navbar-nav">
            ...
            <div class="dropdown">
                <button class="btn btn-secondary dropdown-toggle nav-link" type="button" id="profileDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    My Profile
                </button>
    ...
    <div class="container my-5">
        <div class="row text-center">
            ...
            <div class="col">
                <div class="icon-circle">
                    <img src="../assets/images/theatre.png" alt="Performing Arts">
                </div>
            ...
            <div class="col">
                <div class="icon-circle">
                    <img src="../assets/images/training.png" alt="Conferences & Seminars">
                </div>
